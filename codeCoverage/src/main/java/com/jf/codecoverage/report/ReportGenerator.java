 ...
 *
 *******************************************************************************/
package com.jf.codecoverage.report;
...
import com.jf.codecoverage.HTMLFormatter;
import java.io.File;
...
public class ReportGenerator {
    ...
    private List<File> fileSets(String dir) {
        ...
        filterEc(path,fileSetList);
        return fileSetList;
    }


    private void filterEc(File file, List<File> fileList) {
        if (file != null && fileList != null) {
            ...
            } else if (file.isFile() && (file.getName().endsWith(".exec") || file.getName().endsWith(".ec"))) {
                fileList.add(file);
            }
        }
